...
var wasmBinaryFile;
  wasmBinaryFile = 'duktape_example_1.wasm';
...
var ASM_CONSTS = {
  39400: () => { console.log('wasm js runtime is ready!') },  
 39443: () => { window.runScript = Module.cwrap('runScript', 'string', ['string']) }
};
...
/** @type {function(...*):?} */
var _runScript = Module["_runScript"] = createExportWrapper("runScript");
/** @type {function(...*):?} */
